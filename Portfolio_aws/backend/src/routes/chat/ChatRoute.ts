...
router.get('/chat/chatRoomMessage/:roomId', ChatController.selectListChatRoomMessage); //채팅방 입장
router.post('/chat/sendMessge/:roomId', ChatController.insertChatMessage); //채팅 메시지 전송
